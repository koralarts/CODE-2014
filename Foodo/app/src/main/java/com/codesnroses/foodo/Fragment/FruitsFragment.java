 ...
 */
public class FruitsFragment extends BaseFragment implements SearchView.OnQueryTextListener, AdapterView.OnItemSelectedListener {

    public FruitsFragment() {
        this.jsonFile = "fruits.json";
    }
